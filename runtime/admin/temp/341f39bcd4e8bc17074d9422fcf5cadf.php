<?php /*a:1:{s:66:"D:\phpstudy_pro\WWW\gitShopTP\shopTP\app\admin\view\goods\add.html";i:1594284732;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form layui-form-item spec-is-show">
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate', 'element'], function () {
        ...
        layedit.set({
            uploadImage: {
                url: '<?php echo url('image/layuiUpload'); ?>',
                type: 'post',
            }
        })
        ...
        layui.form.on('submit(*)', function (data) {
            ...
            layObj.post(url, goods_data,  (res) =>{
                if(res.status == 1) {
                  console.log(res);
                    layer.msg("商品新增成功");
                    window.location="<?php echo url('Goods/index'); ?>";
                } else {
                  console.log(res);
                    layer.msg("商品新增失败");
                }
