<?php /*a:1:{s:68:"D:\phpstudy_pro\WWW\gitShopTP\shopTP\app\admin\view\login\login.html";i:1589877458;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form" action="">
            ...
            <div>
               ...
               <div class="admin-captcha"><?php echo captcha_img('',95,40); ?></div>
               <!-- <div><img src="<?php echo url('admin/Verify/index'); ?>" alt="captcha" id="canvas" οnclick="this.src=<?php echo url('admin/Verify/index'); ?>?id= + Math.random()" class="admin-captcha" width="90" height="40"/></div> -->
            </div>
