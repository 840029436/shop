<template>
  <div>
    ...
    <div class="footer-login container clearfix">
      ...
      <!-- 版权 -->
      <p class="copyright">
        © 2005-2018 X袋网 版权所有，并保留所有权利。 技术支持：
        <a
          style="font-family:'Microsoft Yahei'; color:#666;"
          href="http://www.jsdaima.com/"
          title="js代码"
          target="_blank"
        >js代码</a>
        <br />ICP备案证书号：ICP备XXXXXXXX号&nbsp;&nbsp;&nbsp;&nbsp;中国北京朝阳区环球国际金融中心大厦99F&nbsp;&nbsp;&nbsp;&nbsp;Tel:
      ...
      $(".getsms").click(function() {
        ...
        switch (phone.validatemobile()) {
          case 0:
            // 短信验证码的php请求
            error.html(
              msgtemp("验证码 <strong>已发送</strong>", "alert-success")
            );
            $(this).rewire(60);
            break;
          case 1:
          ...
          case 2:
            error.html(
              msgtemp(
                "<strong>手机号码错误</strong> 请输入11位数的号码",
                "alert-warning"
              )
            );
            break;
