        ...
        <div class="pull-right">
          <div class="user-content__box clearfix bgf">
            ...
            <form action class="user-addr__form form-horizontal" role="form">
              <p class="fz18 cr">
                新增收货地址
                <span class="c6" style="margin-left: 20px">电话号码、手机号码选填一项，其余均为必填项</span>
              </p>
              <div class="form-group">
                <label for="name" class="col-sm-2 control-label">收货人姓名：</label>
                <div class="col-sm-6">
                  <!--                                    <input class="form-control" id="name" placeholder="请输入姓名" type="text">-->
                  <Input v-model="value" id="name" placeholder="请输入姓名..." style="width: 300px" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="addr-list">
              <div class="addr-item">
                ...
                <div class="tdf1 order">
                  <a href="udai_address_edit.html">修改</a>
                  <a href>删除</a>
                </div>
                <div class="tdf1">
