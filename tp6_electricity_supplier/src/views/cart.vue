          ...
          <div class="shopcart-form__box">
              ...
              <tbody>
                <tr v-for="(v,k) in list">
                  ...
                  <td>
                    ...
                    <div class="type c9">
                      颜色分类：
                      <span v-text="v.name"></span> 尺码：
                      <span v-text="v.type2"></span>
                    </div>
                  </td>
                  <td>
                    ¥
                  ...
                  <td>
                    ¥
                    <span v-text="v.price*v.num"></span>
                  </td>
                  <td>
                    <a @click="del(k)">删除</a>
                  </td>
            ...
            <div class="checkbox shopcart-total">
              <div class="pull-right">
                已选商品
                <span v-text="totalCount"></span> 件
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合计（不含运费）
                <b class="cr">
                  ¥
                  <span class="fz24" v-text="totalPrice"></span>
                </b>
              </div>
            </div>
          </div>
  ...
  data() {
    return {
      ...
      list: [
        {
          img:
            "https://img13.360buyimg.com/babel/s1180x940_jfs/t1/92005/33/1475/95815/5dbff7feEa53540d9/487bf5b57271f988.jpg.webp",
          name: "商品一",
          type1: "分类一",
          type2: "分类二",
          price: "1",
        ...
        {
          img:
            "https://img10.360buyimg.com/pop/s1180x940_jfs/t1/56836/4/14213/78090/5db29b29E839ace4d/ff51074905618cb5.jpg.webp",
          name: "商品二",
          type1: "分类三",
          type2: "分类四",
          price: "2",
